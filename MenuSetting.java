...
public class MenuSetting {
	...
	public static String appId = "wx26a2038c029b3956";
    public static String appSecret= "c56b96946df899ee14e6d247a47c2679"; 
    ...
    public static void add() throws JSONException{
        ...
        String json = "{"
                ...
                + "\"type\":\"view\","
                + "\"name\":\"开始答题\","
                + "\"url\":\"http://3u8pfv.natappfree.cc/weather/qa.html\""
                + "}]"
        		+ "},"
        		+ "{"
        		+ "\"name\":\"我的排名\","
